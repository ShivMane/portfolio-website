          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              ...
              <BlurFadeText
                ...
                text="Full Stack Developer building scalable web applications and AI-powered products."
              />
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Here are projects I built across full-stack web development and
                  AI integrations, focused on solving real user problems.
                </p>
              </div>
            </div>
          </BlurFade>
